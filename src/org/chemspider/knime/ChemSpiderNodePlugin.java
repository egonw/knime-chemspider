 ...
 */
public class ChemSpiderNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "org.chemspider.knime";

    // The shared instance.
    private static ChemSpiderNodePlugin plugin;

    /**
     * The constructor.
     */
    public ChemSpiderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ChemSpiderNodePlugin getDefault() {
        return plugin;
    }
